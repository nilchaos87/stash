...
function add_css() {
	...
	style.id = "svelte-3117417307-style";
	style.textContent = "\nbutton[svelte-3117417307], [svelte-3117417307] button {\n  background: #eee;\n  color: #333;\n  border: 1px solid #aaa;\n  cursor: pointer;\n}\n\nbutton[svelte-3117417307]:hover, [svelte-3117417307] button:hover {\n  background: #f9f9f9;\n}\n\n[svelte-3117417307].size-standard, [svelte-3117417307] .size-standard {\n  font-size: 1rem;\n  border-radius: 0.25rem;\n  padding: 0.5rem;\n}\n";
	(0, _shared.appendNode)(style, document.head);
}

function create_main_fragment(state, component) {
	var button = (0, _shared.createElement)('button');
	(0, _shared.setAttribute)(button, 'svelte-3117417307', '');
...
function Button(options) {
	...
	if (!document.getElementById("svelte-3117417307-style")) add_css();
...
function create_main_fragment(state, component) {
	var div_class_value, div_1_style_value, i_class_value, i_style_value;
	...
	(0, _shared.addEventListener)(div, 'click', click_handler);
	...
	return {
		...
		destroy: function destroy() {
			(0, _shared.removeEventListener)(div, 'click', click_handler);
...
function create_main_fragment(state, component) {
	...
	(0, _shared.addEventListener)(input, 'input', input_input_handler);
	...
	return {
		...
		destroy: function destroy() {
			(0, _shared.removeEventListener)(input, 'input', input_input_handler);
		}
	};
}
...
function create_main_fragment(state, component) {
	...
	var select = (0, _shared.createElement)('select');
	...
	(0, _shared.addEventListener)(select, 'change', select_change_handler);
	...
	return {
		...
		destroy: function destroy() {
			...
			(0, _shared.removeEventListener)(select, 'change', select_change_handler);
		}
	};
}
...
function create_each_block(state, each_block_value, option, option_index, component) {
	...
	var option_1 = (0, _shared.createElement)('option');
	var text = (0, _shared.createText)(text_value = option);
...
function create_shell_yield_fragment(state, component) {
	...
	var text = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("\n  ");
...
function create_menu_yield_fragment(state, component) {
	...
	var each_block_anchor = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["e" /* createComment */])();
...
function create_panel_1_yield_fragment(state, component) {
	...
	var if_block_anchor = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["e" /* createComment */])();
...
function add_css() {
	...
	style.id = "svelte-4030918317-style";
	style.textContent = "\n[svelte-4030918317].address-container, [svelte-4030918317] .address-container {\n  padding: 0.5rem;\n}\n\n[svelte-4030918317].error, [svelte-4030918317] .error {\n  color: #f00;\n}\n";
...
function create_main_fragment(state, component) {
	...
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["l" /* setAttribute */])(div, 'svelte-4030918317', '');
	...
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("\n  "), div);

	var if_block = state.address && create_if_block(state, component);
	...
	var div_1 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["j" /* createElement */])('div');
	...
	var text_2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])(text_2_value = state.address || 'No address');
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(text_2, div_1);
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("\n  "), div);

	var if_block_1 = state.error && create_if_block_1(state, component);
	...
	return {
		...
		update: function (changed, state) {
			...
			if (text_2_value !== (text_2_value = state.address || 'No address')) {
...
function create_iconbutton_yield_fragment(state, component) {
	var text = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("refresh");
...
function create_if_block(state, component) {
	...
	var p = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["j" /* createElement */])('p');
	var img = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["j" /* createElement */])('img');
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(img, p);
	img.src = img_src_value = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" + state.address;

	return {
		mount: function (target, anchor) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["c" /* insertNode */])(p, target, anchor);
		},

		update: function (changed, state) {
			if (img_src_value !== (img_src_value = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" + state.address)) {
				img.src = img_src_value;
			}
		},

		unmount: function () {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["d" /* detachNode */])(p);
		},
...
function create_if_block_1(state, component) {
	...
	var div = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["j" /* createElement */])('div');
	div.className = "error";
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("ERROR: "), div);
	var text_1 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])(text_1_value = state.error);
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(text_1, div);
...
function Address(options) {
	...
	this._torndown = false;
	if (!document.getElementById("svelte-4030918317-style")) add_css();
	this._renderHooks = [];
...
function create_main_fragment(state, component) {
	...
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("\n  "), div);
	var h2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["j" /* createElement */])('h2');
	...
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("Distribution"), h2);
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["k" /* appendNode */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("\n  "), div);
	...
	var text_4 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Users_nick_Projects_nilchaos87_stash_node_modules_svelte_shared_js__["b" /* createText */])("\n  ");
